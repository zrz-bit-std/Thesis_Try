...
# # ========== 环境变量 ==========
data_name=train_sh_23d_road_6_20250517_5000_lx_4
src_dir=/data1/turbo_data/lishuaiyin/4D_label/origin
dst_dir=/rss/lishuaiyin/4D_label/dataset_track
bev_config=/rss/lishuaiyin/4D_label/BEVFUSION/configs/camera+lidar+fisheye/raw_bevfusion_plus_fisheye_4D_prelabel_v2_200x200m.yaml
...
# # ======== Step 6: 生成评测指标=======
# # =====================================
# # echo "========== 🚩 Generate a jsonfile  =========="
# python  ./visual_data/metric_eval_track_lisy.py --create-map 

# # echo "========== 🚩 Generate a metric  =========="
# python  ./visual_data/metric_eval_track_lisy.py