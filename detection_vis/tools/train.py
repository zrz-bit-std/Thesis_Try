"""Training script for vision detection module."""
...
from detzero_det_vis.models import BEVFormer, build_network, model_fn_decorator
from train_utils import train_model


def parse_config():
    parser = argparse.ArgumentParser(description='Vision detection training')
    parser.add_argument('--cfg_file', type=str, default=None, help='config file for training')
    ...
    parser.add_argument('--extra_tag', type=str, default='default', help='extra tag')
    ...
    parser.add_argument('--max_ckpt_save_num', type=int, default=8)
...
def main():
    ...
    if args.batch_size is None:
        ...
        assert args.batch_size % total_gpus == 0, 'Batch size should be divisible by num GPUs'
    ...
    # Test the latest checkpoint if not skipped
